...
# Single-threaded BLAS backends -- CaImAn's own multiprocessing cluster handles
# parallelism, letting BLAS also multithread underneath causes oversubscription
